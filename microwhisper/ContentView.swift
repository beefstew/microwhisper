                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    HStack(alignment: .center, spacing: 12) {
                        Picker(
                            ...
                            Text("None").tag(
                                Optional<AudioRecorderManager.AudioDevice>.none
                            )
                        ...
                        HStack {
                            ...
                            Button(action: {
                                ...
                                Image(systemName: "doc.on.doc")
                                    .font(.system(size: 14))
                                    .foregroundColor(
                                        hoveringCopy ? .primary : .secondary
                                    )
                            }
                            .buttonStyle(PlainButtonStyle())
                            .onHover { hovering in
...
#Preview("Recording") {
    ...
    vm.transcript =
        "This is a sample transcript that has been captured from the microphone."
    return ContentView().environmentObject(vm)
}
    ...
    class Coordinator: NSObject {
        ...
        @objc func didLiveScroll(_ notification: Notification) {
            ...
            let distanceFromBottom =
                documentView.frame.maxY - scrollView.documentVisibleRect.maxY
